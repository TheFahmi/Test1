...
class Carousels extends Component {
    render(){
        return (
            <Carousel autoPlay showThumbs={false} infiniteLoop={true} centerMode={true} axis="horizontal" className="full-width-div" style={{marginLeft: '-25px', marginRight: '-25px', marginBottom: '200px'}}>
                <div>
                    ...
                    <img src="https://cdn.neow.in/news/images/uploaded/2018/09/1536774109_screenshot_(25).jpg"
                        alt="Gambar 1" width={500} height={300}
                        className="img-fluid" />
                    </a>
                </div>
                <div>
                    ...
                    <img src="https://i.ytimg.com/vi/naIaW4pk_-o/maxresdefault.jpg"
                        alt="Gambar 2" width={500} height={300} className="img-responsive" />
                    </a>
                </div>
                <a href="/productsgridview">
                <div>
