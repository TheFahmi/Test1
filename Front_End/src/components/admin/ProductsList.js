            ...
            return (
                <tfoot>
                    <tr>
                        ...
                        <td>
                            <input type="number" size="8" placeholder="qty"
                                ref="addqty" style={{ fontSize: "13px" }}
                                className="form-control" />
                        </td>
                        <td>
            ...
            if (item.id === this.state.selectedIdEdit) {
                return (
                    <tr>
                        ...
                        <td style={{ fontSize: '14px', }}><input type="number" defaultValue={item.qty} size="4" style={{ fontSize: "13px" }} ref="updateqty" className="form-control"></input></td>
            ...
            if (this.props.myRole === "SUPERADMIN" || this.props.myRole === 'EDITOR') {
                return (
                    <tr>
                        ...
                        <td style={{ fontSize: '14px', }}>{item.qty}</td>
